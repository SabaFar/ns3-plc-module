...
int main (int argc, char *argv[])
{
	...
	Ptr<PLC_Line> Edge12 = CreateObject<PLC_Line> (mainCable, n1, n2);
	Ptr<PLC_Line> Edge23 = CreateObject<PLC_Line> (mainCable, n2, n3);
	Ptr<PLC_Line> Edge34 = CreateObject<PLC_Line> (mainCable, n3, n4);
	Ptr<PLC_Line> Edge15 = CreateObject<PLC_Line> (houseCable, n1, n5);
	Ptr<PLC_Line> Edge26 = CreateObject<PLC_Line> (houseCable, n2, n6);
	Ptr<PLC_Line> Edge37 = CreateObject<PLC_Line> (houseCable, n3, n7);
	Ptr<PLC_Line> Edge48 = CreateObject<PLC_Line> (houseCable, n4, n8);
...
//	Simulator::Schedule(Seconds(2), &PLC_Outlet::SetImpedance, outlet6, Create<PLC_ConstImpedance> (sm, PLC_Value(5,0)), true);
	Ptr<PLC_EdgeTransferUnit> PPP = CreateObject<PLC_EdgeTransferUnit> (  PeekPointer(Edge12) , PeekPointer(n2) , sm, false);
	time_t start, end;
	time (&start);
